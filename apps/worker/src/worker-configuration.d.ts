/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc src/worker-configuration.d.ts` (hash: 9839ffdcb7f7f74cd9eee9773240f99c)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ORIGIN" | "EMAIL_FROM">> {}
}
