/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc src/worker-configuration.d.ts` (hash: a0d3c0f867d1d3d24a65c86a32b3c412)
// Runtime types generated with workerd@1.20260811.1 2026-08-13 nodejs_compat
interface __BaseEnv_Env {
	RELEASES: R2Bucket;
	DB: D1Database;
	EMAIL: SendEmail;
	PUBLIC_ORIGIN: "https://play.digipology.com";
	EMAIL_FROM: "noreply@digipology.com";
	AI_DAILY_USD_CAP: "1";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PUBLIC_ORIGIN" | "EMAIL_FROM" | "AI_DAILY_USD_CAP" | "DEEPSEEK_MODEL">> {}
}
