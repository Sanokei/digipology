...
<!-- Ported from /docs/actions.md — the source of truth is /docs in the repository root. Edit there first, then sync this copy. -->

> Lua creator methods that produce these actions are documented in the [Lua API v1 reference](/docs/lua-api/). This page is the creator- and implementer-facing rendering of Appendix C, not a replacement for the normative specification.
...
- [`SPEC 03.3` (ordered actions and rejection), `SPEC 03.4` (mutation boundary), and `SPEC 03.6`-`03.9`](https://github.com/Sanokei/digipology/blob/main/docs/spec/handoff-v2.txt)
- [`SPEC 04` (Lua API v1), especially `04.4`-`04.8`](https://github.com/Sanokei/digipology/blob/main/docs/spec/handoff-v2.txt)
- [`Appendix C` (Canonical Action Registry v1), including `C.1` and `C.2`](https://github.com/Sanokei/digipology/blob/main/docs/spec/handoff-v2.txt)
